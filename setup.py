...
setup(name='Obmenu',
      ...
      py_modules=['obxml'],
<<<<<<< Updated upstream
      data_files=[(libdir, ['obmenu.ui']), ("%s/icons" % libdir, ['icons/mnu16.png','icons/mnu48.png'])],
=======
      data_files=[(libdir, ['obmenu.glade', 'obmenu.ui']), ("%s/icons" % libdir, ['icons/mnu16.png','icons/mnu48.png'])],
>>>>>>> Stashed changes
      )
